<template>
    <el-container class="home_container">
        <el-header>
            <div class="home_title">Inventory Management Console</div>
            <div class="home_userinfoContainer">
                <el-dropdown @command="handleCommand">
                  <span class="el-dropdown-link home_userinfo">
                    admin<i class="el-icon-arrow-down el-icon--right home_userinfo"></i>
                  </span>
    ...
    export default{
        methods: {
            handleCommand(command){
                var _this = this;
                if (command == 'logout') {
                    this.$confirm('sure to logout?', 'Message', {
